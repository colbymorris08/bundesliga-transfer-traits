...
**0.691**, confirming that party shifts are not random but follow identifiable
patterns. The ensemble model achieves **0.660** ROC-AUC on out-of-sample data
(2010–2024).
...
|---|---|---|
| Random Forest | 0.691 | 0.257 |
| Gradient Boosting | 0.676 | 0.117 |
| Ensemble | 0.660 | 0.183 |
...
**MENA + Persian Sphere:** ROC-AUC 0.452 (n=495, 9 countries, event rate 7.1%)

**Latin America:** ROC-AUC 0.700 (n=1100, 20 countries, event rate 9.8%)

**Sub-Saharan Africa:** ROC-AUC 0.676 (n=385, 7 countries, event rate 5.5%)

**Asia-Pacific:** ROC-AUC 0.612 (n=495, 9 countries, event rate 8.9%)
